https://developer.go.ke/apis/Rental_Withholding

Rental Withholding PRN Generation
By KRA

https://sbx.kra.go.ke/generate/v1/prn/whtrental

Documentation

Overview
This API endpoint submits Rental withholding tax transaction data to the Kenya Revenue Authority and generates a Payment Reference Number (PRN) to facilitate payment of the withheld tax. The payload contains header information summarizing the entire transaction and detailed breakdowns of individual withholding transactions.

For a Rental Withholding Certificate to be issued to the withholdee, the generated PRN needs to be paid for. The withholding certificate generation is automated from the iTax system.
...
✅ Step 2: Invoke Rental Withholding PRN Generation API Endpoint
Endpoint:

POST https://sbx.kra.go.ke/generate/v1/prn/whtrental - Sandbox Endpoint
POST https://api.kra.go.ke/generate/v1/prn/whtrental - Production Endpoint
Root Object
...
Field	Type	Required	Description	Format/Example
typeOfProperty	string	Yes	Type of Property	Possible Values:
1) Commercial
2) Residential
landlordPin	string	Yes	PIN of the Landlord	Format: P000000000L
...
lrNumber	string	Yes	Land Registration Number of property	Example: NAIROBI/BLOCK0/001
building	string	Yes	Building where property is located	Example: Another Tower
street	string	Yes	Street where property is located	Example: Hale Lassie Avenue
town	string	Yes	Town where property is located	Example: Nairobi
...
Request Example
POST https://sbx.kra.go.ke/generate/v1/prn/whtrental
Headers:
...

{
  "transactionHeader": {
    ...
    "transactionUniqueNo": "20220120ITN10",
    "noOfTransactions": 1,
    "taxObligation": "WHTRENT",
    "taxPeriodFrom": "2025-09-01T00:00:00",
    "taxPeriodTo": "2025-09-30T00:00:00",
    "totalGrossAmount": "50050.00",
    "totalTaxAmount": "3754"
  },
  "transactionDetails": [
    {
         "typeOfProperty":"Residential",
         "landlordPin":"P000000000L",
         "paymentDate":"2025-09-19T00:00:00",
         "invoiceNo":"KRACU000000006",
         "invoiceDate":"2025-09-19T00:00:00",
